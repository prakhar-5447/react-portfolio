  ...
  return (
    <div className="card container mx-auto w-2/5 rounded-3xl text-center bg-white flex p-20 justify-center">
      <div className="inside_card flex flex-col items-center my-3">
        ...
        <div className="flex flex-col justify-center ">
          <div className="left_content_logo flex items-center justify-between mt-6">
            <a href="https://instagram.com/prakhar_5447" target="_blank" rel="noreferrer" className="left_content_img m-2">
              <img
                src={insta_logo}
                alt=""
                width={30}
            ...
            <a href="https://twitter.com/prakhar_5447" target="_blank" rel="noreferrer" className="left_content_img m-2">
              <img
                src={twitter_logo}
                alt=""
                width={30}
            ...
            <a href="https://www.linkedin.com/in/prakhar-sahu-4519b8206" target="_blank" rel="noreferrer" className="left_content_img m-2">
              <img
                src={linkedin_logo}
                alt=""
                width={30}
            ...
            <a href="https://github.com/prakhar-5447" target="_blank" rel="noreferrer" className="left_content_img m-2">
              <img
                src={github_logo}
                alt=""
                width={30}
      ...
      <div className="right_content flex text-left flex-col justify-evenly ml-20">
        <div className="">
          <div className="right_content_text font-bold text-2xl">PRAKHAR SAHU</div>
